...
/** Based on RegExp object for Flash5 ActionScript Ver1.01<br/>
*RegExp is defined in Javascript and Actionscript 3 but is missing in Actionscript 2 (see Actionscript 3 documentation).<br>
*Test Regular Expressions at <a href='http://www.jurjans.lv/flash/RegExp_test.html'>http://www.jurjans.lv/flash/RegExp_test.html</a>.<br>
*Read a nice summary of their use at <a href='http://www.websina.com/bugzero/kb/regexp.html'>http://www.websina.com/bugzero/kb/regexp.html</a><br>
...
class RegExp {
	 ...
	 * @usage import edu.clips.util.RegExp;<BR>var thing = new RegExp(string, flags, mystery); <BR>
	 ...
	 * @example import edu.clips.util.RegExp;<BR>var re = new RegExp("\\s+CLIPS","g");
	 */
	...
	*@returns <code>(String)</code> Details of the current version. */
	...
	/**Used to test whether a string has a pattern defined by the Regular Expression 
	*@usage re.test(string) 
	*@param string   <code>(String)</code> The string to be searched
	*@returns Boolean indicating whether the pattern was found
	*@example nameof = "StandardStart27_mc"<BR>var re = new RegExp("Start","g");<BR>trace("Does the string include 'Start'? "+re.test(nameof)); //outputs true*/
	...
	*@usage re.exec(string) 
	*@param string   <code>(String)</code> The string to be pattern-matched
	*@returns Object with properties index (the position), input (the string) and 0 (the matched character(s))<br>
	...
	*@example p2 = new RegExp("\\d+","g");<br>
		next_string = "I have 23 ways to list 5 objects on 217 pieces of paper";<br>
		var results1:Object = p2.exec(next_string);<br>
		while (results1 != null)<br>
			{<br>
				for (var prop in results1){<br>
					trace("   * "+prop+" : "+results1[prop]);<br>

				}<br>
				results1 = p2.exec(next_string);<br>
			}<br>*/
	...
	public static function setStringMethods() {
		trace("setStringMethods being defined");
        if(String.prototype.match != undefined) {
			trace("Warning - match is already defined, String.prototype functions will be overridden");
            //return;
        }
		if (String.prototype.replace != undefined){
			trace("Warning - replace is being replaced");
		}
		/**Finds the characters that match the pattern defined by the regular expression.<br>
		Use the "g" flag to repeat the process over and over. <br>
		...
		*@example 	nameof = "StandardStart27_mc"; <br>
					p2 = new RegExp("\\d+","g");<br>
					trace("The digits are " + nameof.match(p2)[0]); //output 27<br>*/
		...
		/**Replace the characters that match the pattern defined by the regular expression with another string.<br>
		*or Replace the given substring with another one (Based on a idea of Davide Beltrame (Broly))
		*found on <a href='http://www.sephiroth.it/proto_detail.php?id=16'>http://www.sephiroth.it/proto_detail.php?id=16</a><br>
		Added to String.prototype so that it can be used with any string.
		*@usage string.replace(re, new_string);
		*@usage string.replace(found_string, new_string);
		*@param re <code>(RegExp)</code> The Regular Expression with the pattern to be matched
		*@param found_string <code>(String)</code> The string to be matched
		*@param new_string <code>(String)</code> The string to use in the replacement
		*@returns String with replacement(s) made.
		*@example 	test_txt = "  swf  Missippi River   "; <br>
					p1 = new RegExp("\\s+","g");<br>
					trace(test_txt.replace(p1,"*")); //output '*swf*Missippi*River*'<br><br>
		*@example test = ".swflib/actions/test.swf is a .swf";<br>
		* trace(test+", "+test.replace('.swf', ''));  //.swflib/actions/test.swf is a .swf, lib/actions/test is a<br>
		*/
		...
		/**Trim whitespace from the beginning of a string.<br>
		*Added to the class, informed by <a href='http://www.somacon.com/p355.php'>http://www.somacon.com/p355.php</a><br>
		*Added to String.prototype so that it can be used with any string.
		*@usage string.ltrim();
		*@returns trimmed String
		*@example 	test_txt = "&nbsp;&nbsp;swf&nbsp;&nbsp;&nbsp;Missippi&nbsp;River&nbsp;&nbsp;&nbsp;&nbsp;"; <br>
					trace(test_txt.ltrim()); //output 'swf&nbsp;&nbsp;&nbsp;Missippi&nbsp;River&nbsp;&nbsp;&nbsp;&nbsp;'<br><br>
		*/
		...
		*@returns trimmed String
		*@example 	test_txt = "&nbsp;&nbsp;swf&nbsp;&nbsp;&nbsp;Missippi&nbsp;River&nbsp;&nbsp;&nbsp;&nbsp;"; <br>
					trace(test_txt.rtrim()); //output '&nbsp;&nbsp;swf&nbsp;&nbsp;&nbsp;Missippi&nbsp;River'<br><br>
		*/
		...
		/**Trim whitespace from the beginning and end of a string.<br>
		*Added to the class by the CLIPS team<br>
		*Added to String.prototype so that it can be used with any string.
		*@usage string.trim();
		*@returns trimmed String
		*@example 	test_txt = "&nbsp;&nbsp;swf&nbsp;&nbsp;&nbsp;Missippi&nbsp;River&nbsp;&nbsp;&nbsp;&nbsp;"; <br>
					trace(test_txt.trim()); //output 'swf&nbsp;&nbsp;&nbsp;Missippi&nbsp;River'<br><br>
		*/
		...
		/**Tests for a match in a string.<br>
		*Added to String.prototype so that it can be used with any string.
		*@usage string.search(re);
		*@returns the index of the match, or -1 if the search fails.
		*@example 	test_txt = "Therrrre Grrrrrrrrrreat"; <br>
					re = new RegExp("r+e","g");
					trace(test_txt.search(re)); //output 3<br><br>
		*@see test
		*/
		...
		/**Adds the ability to split a string based on a RegExp.<br>
		*Added to String.prototype so that it can be used with any string.
		...
		*@example 	test_txt = "Therrrre Grrrrrrrrrreat"; <br>
					re = new RegExp("r+e","g");<br>
					trace(test_txt.split(re)); //output [The, G,at]<br>
					trace(test_txt.split("r"); //output [The,,,,e G,,,,,,,,,,eat]<br><br>
		*/
